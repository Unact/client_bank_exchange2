...
module ClientBankExchange2
  module Models
    ...
    class Document < Dry::Struct
      ...
      attribute :payer_account_number?, Types::String.optional.meta(tag_name: "ПлательщикСчет")
      ...
      attribute :payer_inn?, Types::String.optional.meta(tag_name: "ПлательщикИНН")
      ...
      attribute :receiver_account_number?, Types::String.optional.meta(tag_name: "ПолучательСчет")
      ...
      attribute :receiver_inn?, Types::String.optional.meta(tag_name: "ПолучательИНН")
